...
func _App_UpdateUserBnbBalance0_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in UpdateUserBnbBalanceRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationAppUpdateUserBnbBalance)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.UpdateUserBnbBalance(ctx, req.(*UpdateUserBnbBalanceRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*UpdateUserBnbBalanceReply)
		return ctx.Result(200, reply)
	}
}

func _App_SetAllUserBnbBalance0_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in SetAllUserBnbBalanceRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationAppSetAllUserBnbBalance)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.SetAllUserBnbBalance(ctx, req.(*SetAllUserBnbBalanceRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*SetAllUserBnbBalanceReply)
		return ctx.Result(200, reply)
	}
}
...
func (c *AppHTTPClientImpl) SetAllUserBnbBalance(ctx context.Context, in *SetAllUserBnbBalanceRequest, opts ...http.CallOption) (*SetAllUserBnbBalanceReply, error) {
	var out SetAllUserBnbBalanceReply
	pattern := "/api/admin_dhb/set_all_user_bnb_balance"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationAppSetAllUserBnbBalance))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *AppHTTPClientImpl) UpdateUserBnbBalance(ctx context.Context, in *UpdateUserBnbBalanceRequest, opts ...http.CallOption) (*UpdateUserBnbBalanceReply, error) {
	var out UpdateUserBnbBalanceReply
	pattern := "/api/admin_dhb/update_user_bnb_balance"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationAppUpdateUserBnbBalance))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
